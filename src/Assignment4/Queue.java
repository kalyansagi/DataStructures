...
// Method for size, counts and gives us the number of elements (nodes) in our Queue
   public int Size()
   {
      ...
      while (Current3 != null) //While the Current node doesn't equal null move forward node by node counting each node as you pass them by
      {
         size= size+1;
         Current3= Current3.next;
      }
      return size;  //Return the number of elements (leave method useful for when we want to remove/add at an index >= Count)
   }
